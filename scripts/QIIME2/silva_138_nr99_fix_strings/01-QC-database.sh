...
--i-sequences databases/silva_138_nr99_fixed_strings/SILVA138-nr99_fixed_strings_sequences.qza \
--p-num-degenerates 5 \
--p-homopolymer-length 1000 \
--o-clean-sequences databases/silva_138_nr99_fixed_strings/SILVA138-nr99_fixed_strings_sequences_QC.qza
