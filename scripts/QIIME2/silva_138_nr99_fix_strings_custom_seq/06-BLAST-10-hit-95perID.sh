...
qiime feature-classifier classify-consensus-blast \
  ...
  --p-maxaccepts 10 \
  --p-perc-identity .95 \
  --o-classification results/qiime2/taxonomy_assignment/silva_138_nr99_fixed_strings_custom_seq/silva-138-nr99-fixed-strings-custom-seq-blast-10-hit-95perID.qza
