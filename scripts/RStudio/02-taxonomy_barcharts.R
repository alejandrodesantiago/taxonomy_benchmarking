...
ggsave(plot = marine_taxonomy, "results/RStudio/03-taxonomy-barcharts/2022-04-15-visualizing_taxonomy_barcharts_marine_genus.png", height = 6, width = 13, units = "in", device = "png", dpi = 300)
...
p <- ggplot(data = taxonomy_terrestrial_top_7, aes(x = database, y = Freq, fill = Var1, pattern = tool)) +
  ...
  scale_y_continuous(labels = scales::percent_format()) +
  genus_soil
ggsave(plot = p, "results/RStudio/03-taxonomy-barcharts/2022-04-15-visualizing_taxonomy_barcharts_terrestrial_genus.png", height = 6, width = 13, units = "in", device = "png", dpi = 300)
