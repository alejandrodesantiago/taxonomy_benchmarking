...
qiime feature-classifier classify-sklearn \
  ...
  --i-classifier databases/silva_138_nr99/SILVA138-nr99-naive-classifier.qza \
  --p-confidence .90 \
  --o-classification results/qiime2/taxonomy_assignment/silva_138_nr99/silva-138-nr99-naive-90-confidence.qza
